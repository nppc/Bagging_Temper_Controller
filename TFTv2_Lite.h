...
// Font width and spacing
#define FONT_NORMAL 0
#define FONT_BOLD 1

#define FONT_SPACECOND 1
#define FONT_SPACENORM 2
#define FONT_SPACEEXT 3
...
//TFT Inversion constants
#define TFT_INVERT_ON   0x21
#define TFT_INVERT_OFF  0x20
...
extern INT8U simpleFontBig[][14];
extern INT8U bitmapBigNum[][120];
extern INT8U bitmapBigDot[];
extern INT8U simpleFontBig_9bit[];
...
public:
	...
	INT8U readID(void);
    void invertDisplay(byte ccomand);
	void drawChar(INT8U ascii);
	void drawCharPGM(INT8U ascii);
	void drawString(char *string);
	void drawString_P(const char *string);
	void drawStringPGM(char *string);
    void fillRectangle(INT16U poX, INT16U poY, INT16U length, INT16U width);
	
	void drawLine(INT16U x0,INT16U y0,INT16U x1,INT16U y1);
    void drawVerticalLine(INT16U poX, INT16U poY,INT16U length);
    void drawHorizontalLine(INT16U poX, INT16U poY,INT16U length);
    void drawRectangle(INT16U poX, INT16U poY, INT16U width, INT16U height);
    ...
    void drawNumberR(long long_num, INT8U width);
    void drawNumber(long long_num);
    void drawNumberPGM(long long_num);
    void drawFloat(float floatNumber,INT8U decimal);
